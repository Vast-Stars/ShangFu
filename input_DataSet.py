...
TRAIN_IMAGES='./dataset/dataset_2/'
...
def load_images(path):
    ...
    i=0
    data=numpy.zeros((total_number,IMAGE_SIZE,IMAGE_SIZE,3))
    for file in os.listdir(path):
        data[i]=numpy.array(Image.open(os.path.join(os.getcwd(),path, file)))
        i+=1
    print('Extract Image Done!')
    return data
...
def read_data_sets(fake_data=False,
    ...
    # local_file='./dataset/train_label.gzip'
    # with open(local_file, 'rb') as f:
...
if __name__ == '__main__':
    # A=load_labels('./dataset/train_labels.txt',one_hot=True)
    # print(A.shape)
    A=read_data_sets()
